          ...
          <div className={styles.homeDescription}>
            ...
            <Fade delay={300}>
              <Heading type="h6" form="print">
                I am a Jr. Software Engineer passionate about education practices and hopeful about
                a future where society looks up to a higher truth with humility and love to one
                another, regardless of physical or intelectual differences.
              </Heading>
            </Fade>
          </div>
        </div>
        ...
        <div className={classNames(styles.contentWrapper)}>
          <div className={styles.content}>
            ...
            <Fade delay={300}>
              ...
              <Text size="20">
                I choose Information Systems as my bachelor's on distance learning because I was
                young and needed it, and also because I was sure university wouldn't teach
                everything I needed so I had more time to focus on self learning the skills needed
                for work.
              </Text>
            ...
            <div className={styles.marginTop50}>
              ...
              <Fade>
                ...
                <Text size="20">
                  I believe school teaches us very little about how to go on with (mature) life.
                  That is, before taking sides on any opinion, habit or action, one should work
                  primarily on nurturing a solid moral ground - in other words, I can deeply love
                  chocolate cakes, but it is unhealthy and not morally acceptable to eat them all
                  day, everyday.
                </Text>
              </Fade>
            </div>
          ...
          <div className={styles.content}>
            <Fade>
              ...
              <RandomImage
                position="right"
                category="portfolio"
                className={styles.aboutImageFirst}
              />
              ...
              <Text size="20">
                ...
                although still simple, but needed to better comprehend certain skills during the
                last few years. Because of it, however, they are not updated with my current code.
                And since I code mostly everyday for work, I prefer to keep them this way for now.
                We can always chat about current approaches to solving problems and being creative,
                though!
              </Text>
            </Fade>
        ...
        <div className={classNames(styles.contentWrapper)}>
          <div className={styles.content}>
            <Fade>
              ...
              <Text size="20" className={styles.startingParagraph}>
                <Text size="20" className={styles.startingParagraph}>
                  Please use the form if you would like to chat. I will try to reply as soon as I
                  can.
                </Text>
                <Text size="20">
